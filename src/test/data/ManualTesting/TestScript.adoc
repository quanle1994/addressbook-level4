...
* In the first copy, delete the lines 489 to 544. Rename the file addressbook.xml
* In the second copy, delete the lines 2 to 488. Rename the file eventbook.xml
