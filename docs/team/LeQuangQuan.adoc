...
code]][https://github.com/CS2103AUG2017-T14-B2/main/blob/master/collated/test/quanle1994.md[Test code]]
...
Ordering is essential to TunedIn. It provides the fundamental functionality of an organizer.
With the ordering mechanism, user will be able to order the list of contacts in 14 different ways. This
is in line with our goal in making TunedIn as customizable as possible, allowing the user to organize the contacts to
their most preferred way.

==== Implementation

This command was first developed by me and later on enhanced by Xiang TingTing
